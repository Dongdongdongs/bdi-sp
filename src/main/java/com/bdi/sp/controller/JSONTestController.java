...
public class JSONTestController {
	 ...
	 * public @ResponseBody String getTest(@RequestParam(value="a",required=false)
	 * String str,
	 * 
	 * @PathVariable String b) { System.out.println("b : " + b);
	 ...
	 * public @ResponseBody List<Japan> postTest(@RequestBody List<Japan> j,
	 * 
